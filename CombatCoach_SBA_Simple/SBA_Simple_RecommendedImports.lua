...
SBASGUI2|1|253;R,883,Call Pet 1,has_pet~1~this~~~~~~;R,982,Revive Pet,pet_alive~1~this~~~~~~;R,217200,Barbed Shot,(on_cd~1~num~19574~~~~~,&&plugin~0~this~~~<=~tt_253_2~3~),&&has_stacks~0~this~~~~~>=1~;R,19574,Bestial Wrath,on_cd~0~this~~~~~~;R,1264359,Wild Thrash,on_cd~0~this~~~~~~,&&target_count~0~this~~~>=~~2~;R,34026,Kill Command,has_stacks~0~this~~~~~>=1~,&&(talented~1~num~1273126~~~~~,|plugin~0~this~~~~tt_253_5~~),&&plugin~0~this~~~~dynact_253_34026~~;R,466930,Black Arrow,plugin~0~this~~~~tt_253_4~~,&&on_cd~0~this~~~~~~,&&plugin~0~this~~~~dynact_253_466930~~,&&talented~0~this~~~~~~;R,392060,Wailing Arrow,plugin~0~this~~~<~tt_253_4~4~,&&plugin~0~this~~~~dynact_253_392060~~,&&on_cd~0~this~~~~~~,&&talented~0~this~~~~~~;R,34026,Kill Command,on_cd~0~this~~~~~~,&&(talented~1~num~1273126~~~~~,|plugin~0~this~~~~tt_253_5~~),&&usable~0~this~~~~~~;R,217200,Barbed Shot,has_stacks~0~this~~~~~>=1~,&&resource~0~this~~chi~<~~75~;R,466930,Black Arrow,on_cd~0~this~~~~~~,&&reactive_enabled~0~this~~~~~~,&&talented~0~this~~~~~~;R,193455,Cobra Shot,usable~0~this~~~~~~,&&(plugin~0~this~~~~dynact_253_193455~~,&&(talented~0~num~1273126~~~~~,&&plugin~1~this~~~~tt_253_5~~),|has_stacks~0~num~34026~~~~0~);R,1229376,Single-Button Assistant]],
    },
    [255] = {
