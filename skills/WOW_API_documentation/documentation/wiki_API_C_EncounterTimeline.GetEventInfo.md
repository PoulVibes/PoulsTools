...
| iconFileID | [fileID](wiki_FileDataID.md "FileDataID") : number | Icon file ID associated with this event. |
...
| color | [colorRGB](wiki_ColorMixin.md "ColorMixin") | 12.0.1 - Color to use for displaying this event. May be overridden by C\_EncounterEvents APIs, else will default to an appropriate color for the current view mode. |
