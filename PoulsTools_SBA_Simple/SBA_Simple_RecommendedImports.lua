...
_G.SBAS_RecommendedImports = {
    [253] = {
        ...
        importText = [[SBASGUI2|1|253;R,217200,Barbed Shot,(on_cd~1~num~19574~~~~~,&&plugin~0~this~~~<~bestial_wrath_cooldown~2~);R,19574,Bestial Wrath,on_cd~0~this~~~~~~;R,131251,Wild Thrash,on_cd~0~this~~~~~~,&&target_count~0~this~~~>=~~2~;R,34026,Kill Command,plugin~0~this~~~>~bestial_wrath_cooldown~4~,&&(plugin~0~this~~~~natures_ally~~,||plugin~0~this~~~~howl_proc~~);R,141219,Black Arrow,plugin~0~this~~~~withering_fire_active~~,&&on_cd~0~this~~~~~~;R,392060,Wailing Arrow,plugin~0~this~~~<~withering_fire~4~,&&usable~0~this~~~~~~;R,34026,Kill Command,on_cd~0~this~~~~~~;R,217200,Barbed Shot,(plugin~0~this~~~>=~barbed_shot_stacks~2~,||resource~0~this~~focus~<~~75~);R,141219,Black Arrow,on_cd~0~this~~~~~~;R,193455,Cobra Shot,usable~0~this~~~~~~;R,1229376,Single-Button Assistant]],
    },
    [269] = {
