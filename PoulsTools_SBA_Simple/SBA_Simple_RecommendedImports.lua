...
_G.SBAS_RecommendedImports = {
    ...
    [253] = {
        ...
        source = "Working per Spec Overrides/MID1_Hunter_Beast_Mastery.txt",
        importText = [[SBASGUI2|1|253;R,19574,Bestial Wrath,on_cd~0~this~~~~~~;R,217200,Barbed Shot,plugin~0~this~~~~<~barbed_shot_stacks~2~;R,34026,Kill Command,usable~0~this~~~~~~;R,193455,Cobra Shot,resource~0~this~~focus~<~~75~;R,193455,Cobra Shot,plugin~0~this~~~~<~barbed_shot_stacks~2~;R,141219,Black Arrow,plugin~0~this~~~~withering_fire_active~~;R,392060,Wailing Arrow,plugin~0~this~~~~withering_fire_active~~;R,1229376,Single-Button Assistant]],
    },
}
